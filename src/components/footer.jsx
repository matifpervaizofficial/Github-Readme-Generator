  ...
  <div className="bg-gray-100 p-4 flex flex-col justify-center items-center shadow-inner mt-2">
    <div className="w-full flex flex-col sm:flex-row justify-evenly py-2">
      ...
      <div className="text-xl sm:text-base font-light sm:font-normal">
        ...
        <div className="ml-2 sm:ml-0">
          <a
            href="https://github.com/matifpervaizofficial/github-profile-readme-generator"
            aria-label="Github matifpervaizofficial/github-profile-readme-generator"
            target="blank"
          >
            Github
          </a>
        ...
        <div className="ml-2 sm:ml-0">
          <a
            href="https://github.com/matifpervaizofficial/github-profile-readme-generator/releases"
            aria-label="Releases on Github matifpervaizofficial/github-profile-readme-generator"
            target="blank"
          >
            Releases
          </a>
        ...
        <div className="ml-2 sm:ml-0">
          <a
            href="https://github.com/matifpervaizofficial/github-profile-readme-generator/issues"
            aria-label="Issues in matifpervaizofficial/github-profile-readme-generator"
            target="blank"
          >
            Issues
          </a>
        ...
        <div className="ml-2 sm:ml-0">
          <a
            href="https://github.com/matifpervaizofficial/github-profile-readme-generator/pulls"
            aria-label="Pull Requests in matifpervaizofficial/github-profile-readme-generator"
            target="blank"
          >
            Pull Requests
          </a>
