      ...
      <div className="w-full sm:w-2/3">
        ...
        <div className="mt-4">
          <a
            ...
            href="https://twitter.com/intent/tweet?text=Wow:&url=https%3A%2F%2Fmatifpervaizofficial.github.io%2Fgithub-profile-readme-generator"
          >
            <img
              className="w-20"
              src="https://img.shields.io/twitter/url?style=social&url=https%3A%2F%2Fmatifpervaizofficial.github.io%2Fgithub-profile-readme-generator"
      ...
      <div className="w-full sm:w-1/3 flex flex-col justify-center items-center">
        ...
        >
          <img
            ...
            alt="Buy ko-fi for matifpervaizofficial"
          />
          Buy me a ko-fi
        </a>
        {/* Paypal */}
        <a
          href="https://www.paypal.me/matifpervaizofficial/10"
        ...
        >
          <img
            ...
            alt="Donate matifpervaizofficial via paypal"
          />
          {/* <img
              className="w-6 h-6 mr-2"
        ...
        {/* BuyMeACoffee */}
        <a
          href="https://www.buymeacoffee.com/matifpervaizofficial"
        ...
        >
          <img
            ...
            alt="Buy matifpervaizofficial A Coffee"
          />
          Buy me a coffee
        </a>
      </div>
